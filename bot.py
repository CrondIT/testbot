...
async def ai_image_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🎨 Режим генерации изображений (DALL-E) активирован. Опишите, что вы хотите увидеть!")
...
📝 Изображение будет автоматически конвертировано в PNG для лучшего качества.
    """
    await update.message.reply_text(help_text)


async def download_and_convert_image(file_id: str, context: ContextTypes.DEFAULT_TYPE) -> io.BytesIO:
    """Скачивает изображение, конвертирует в PNG и возвращает его в виде BytesIO"""
